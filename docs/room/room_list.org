...
Just for random names honestly.
#+begin_src clojurescript :tangle ../../src/room/room_list.cljs
...
This is needed to provide a stub for the RoomListView. We'll likely move it into
it's own file when we have that working properly.
#+begin_src clojurescript :tangle ../../src/room/room_list.cljs
...
For now, we'll look to how Aurora does this in Typescript until we have an even better
feel for the FFI usage for the rust sdk
#+begin_src clojurescript :tangle ../../src/room/room_list.cljs
